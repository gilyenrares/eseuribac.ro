...
if (isset($_POST['reset-request-submit'])) {
	...
	$url = "https://eseuribac.ro/parola-noua.php?selector=". $selector. "&validator=". bin2hex($token);
	...
	$to = $userEmail;
	$subject = 'Resetează parola pentru EseuriBac.ro';
	...
	$headers = "From: no-reply@eseuribac.ro\r\n";
	$headers .= "Reply-to: contact@eseuribac.ro\r\n";
