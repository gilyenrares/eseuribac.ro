        ...
        <div class="layer-text">
          <div class="page-left-2">
            ...
            <div class="page-text w-richtext">
              <h3 class="text-center p-3"><strong>Fizică</strong></h3>
              <h3>"Ce un om numeşte Dumnezeu, un altul le numeşte legile fizicii..."</h3>
              <h3 class="blockquote-footer text-right mr-5">Nikola Tesla</h3>
            </div>
          </div>
        </div>
      </div>
...
<div class="parallax">
  ...
  <div class="container border-top border-danger p-3 mt-5 bg-hologram rounded">
    <h1 id='title'><span>ESEURIBAC</span><br><span>Fizică</span></h1>
  </div>
  <!-- Search bar -->
  <div class="container border-top border-primary p-3 mt-5 bg-hologram text-white rounded">
		<form action="cautare.php" class=" m-2 d-flex flex-row" method="POST">
            <input class="form-control" type="text" name="search" placeholder="Fizică">
            <input type="hidden" name="subject" value="Fizică">
  ...
  <div class="container border-top border-primary p-3 mt-5 bg-hologram rounded">
		<h1 class="text-center text-white">Fizică</h1>
		<div class="row mb-5">
			<ul class="align">
				<?php include'includes/fizica-open.inc.php'; ?>
			</ul>	
		</div>
	</div>
  <!-- The end -->
