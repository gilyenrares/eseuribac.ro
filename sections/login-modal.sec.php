    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="form-group">
		    <label for="labelLU">Numele de utilizator</label>
		    <input type="Username" name="user" class="form-control" id="labelLU" aria-describedby="noteU" placeholder="Aliasul tău/ Username" required="required" value="<?php if (isset($_SESSION['tempUserName'])) {echo $_SESSION['tempUserName'];} ?>">
		    <small id="noteU" class="form-text text-muted">Numele de utilizator este afișat public in postări, etc.</small>
		</div>
		<div class="form-group">
		    <label for="labelLP">Parolă</label>
		    <input type="password" name="pwd" class="form-control" id="labelLP" aria-describedby="noteP" placeholder="Parolă" required="required">
		    <small id="noteP" class="form-text text-muted">Recomandare: Utilizează litere, cifre și caractere speciale.</small>
		</div>
		<div class="form-group">
		    <label for="labelLRPL">Ai uitat parola?</label><br>
		    <a id="labelLRPL" href="resetare-parola.php">Resetează parola.</a>
